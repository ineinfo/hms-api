...
var _require = require('../utils/multerConfig'),
  uploadTest = _require.uploadTest;
var _require2 = require('../utils/common'),
  multerErrorHandler = _require2.multerErrorHandler;

// Add
router.post('/', uploadTest, multerErrorHandler, authMiddleware, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          _context.next = 6;
          return pool.query("SELECT * FROM ".concat(TABLE.BODYTEST_TABLE, " WHERE status = 1 and title = ?"), [title]);
        case 6:
        ...
        case 11:
          baseUrl = req.protocol + '://' + req.get('host') + '/uploads/bodytest/';
          ...
          // ];
          _context.next = 16;
          return pool.query("INSERT INTO ".concat(TABLE.BODYTEST_TABLE, " (title,image_url) VALUES (?,?)"), [title, image_url]);
        case 16:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 5;
          return pool.query("SELECT * FROM ".concat(TABLE.BODYTEST_TABLE, " WHERE status = 1 and id = ?"), [id]);
        case 5:
        ...
        case 11:
          _context2.next = 13;
          return pool.query("SELECT * FROM ".concat(TABLE.BODYTEST_TABLE, " WHERE status = 1 ORDER BY ID DESC"));
        case 13:
...
// Update
router.put('/:id', uploadTest, multerErrorHandler, authMiddleware, /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 12:
          _context3.next = 14;
          return pool.query("SELECT * FROM ".concat(TABLE.BODYTEST_TABLE, " WHERE status = 1 and title = ? AND id != ?"), [title, id]);
        case 14:
        ...
        case 19:
          baseUrl = req.protocol + '://' + req.get('host') + '/uploads/bodytest/'; // Ensure trailing slash
          image_urls = req.files.map(function (file) {
            return baseUrl + file.filename;
          });
          image_url = image_urls.length > 0 ? image_urls[0] : existingMedicine[0].image_url; //     const baseUrl = req.protocol + '://' + req.get('host') + '/uploads/bodytest/';
          // const image_urls = req.files.map(file => baseUrl + file.filename);
          // const image_url = image_urls.length > 0 ? image_urls[0] : '';
          // Update the medicine
          _context3.next = 24;
          return pool.query("UPDATE ".concat(TABLE.BODYTEST_TABLE, " \n             SET title = ?, \n                 image_url = ?, \n                 updated_at = NOW() \n             WHERE id = ?"), [title, image_url, id]);
        case 24:
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
            ...
            var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(deletedId) {
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.next = 2;
                    return pool.query("SELECT * FROM ".concat(TABLE.BODYTEST_TABLE, " WHERE status = 1 and id = ?"), [deletedId]);
                  case 2:
                  case "end":
        ...
        case 7:
          query = "UPDATE ".concat(TABLE.BODYTEST_TABLE, " SET status = 0, deleted_at = NOW() WHERE id IN (?)");
          _context5.next = 10;
