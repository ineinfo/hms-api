...
router.post('/', authMiddleware, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, message, emailExists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, email = _req$body.email, message = _req$body.message;
          if (!(!email || !message)) {
            _context.next = 4;
            break;
          }
          return _context.abrupt("return", res.status(400).json({
            error: 'Email,Phone and Message fields are required',
            status: false
          }));
        case 4:
          if (!email) {
          ...
          _context.next = 7;
          return checkEmailExistOrNot(TABLE.FEEDBACK_TABLE, email);
        case 7:
        ...
        case 12:
          _context.next = 14;
          return pool.query("INSERT INTO ".concat(TABLE.FEEDBACK_TABLE, " (email,message) VALUES (?,?)"), [email, message]);
        case 14:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 9;
          return pool.query("SELECT * FROM ".concat(TABLE.FEEDBACK_TABLE, " WHERE status !=0 and id = ? "), [id]);
        case 9:
        ...
        case 15:
          _context2.next = 17;
          return pool.query("SELECT * FROM ".concat(TABLE.FEEDBACK_TABLE, " WHERE status = 1 ORDER BY id DESC LIMIT ?,?"), [offset, parsedLimit]);
        case 17:
...
router["delete"]('/:id', authMiddleware, /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var idParam, deletedIds, query, _yield$pool$query5, _yield$pool$query6, results;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
            ...
            var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(deletedId) {
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return pool.query("SELECT * FROM ".concat(TABLE.FEEDBACK_TABLE, " WHERE status = 1 and id = ?"), [deletedId]);
                  case 2:
                  case "end":
        ...
        case 7:
          query = "UPDATE ".concat(TABLE.FEEDBACK_TABLE, " SET status = 0, deleted_at = NOW() WHERE id IN (?)");
          _context4.next = 10;
