...
var _require = require('../utils/common'),
  checkPhoneExistOrNot = _require.checkPhoneExistOrNot,
...
router.post('/', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, email, phone, message;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", res.status(400).json({
            error: 'Name,Email,Phone and Message fields are required',
            status: false
          }));
        case 4:
        ...
        case 8:
          _context.next = 10;
          return pool.query("INSERT INTO ".concat(TABLE.CONTACTINQUIRY_TABLE, " (name,email,phone,message) VALUES (?,?,?,?)"), [name, email, phone, message]);
        case 10:
...
router.get('/:id?', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var id, _req$body2, _req$body2$page, page, _req$body2$limit, limit, parsedPage, parsedLimit, offset, _yield$pool$query, _yield$pool$query2, _results, _yield$pool$query3, _yield$pool$query4, results;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          parsedLimit = parseInt(limit) > 0 ? parseInt(limit) : 10;
          ...
          _context2.next = 9;
          return pool.query("SELECT * FROM ".concat(TABLE.CONTACTINQUIRY_TABLE, " WHERE status !=0 and id = ? "), [id]);
        case 9:
          _yield$pool$query = _context2.sent;
          _yield$pool$query2 = _slicedToArray(_yield$pool$query, 1);
          _results = _yield$pool$query2[0];
        ...
        case 15:
          _context2.next = 17;
          return pool.query("SELECT * FROM ".concat(TABLE.CONTACTINQUIRY_TABLE, " WHERE status = 1 ORDER BY id DESC LIMIT ?,?"), [offset, parsedLimit]);
        case 17:
...
router.put('/:id', authMiddleware, /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, _yield$pool$query5, _yield$pool$query6, existingRecord, _req$body3, name, email, phone, message, emailExists, phoneExists, updateQuery, queryParams;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          _context3.next = 6;
          return pool.query("SELECT * FROM ".concat(TABLE.CONTACTINQUIRY_TABLE, " WHERE status = 1 and id = ?"), [id]);
        case 6:
          _yield$pool$query5 = _context3.sent;
          _yield$pool$query6 = _slicedToArray(_yield$pool$query5, 1);
          existingRecord = _yield$pool$query6[0];
        ...
        case 18:
          ...
          _context3.next = 21;
          return checkEmailExistOrNot(TABLE.CONTACTINQUIRY_TABLE, email, id);
        case 21:
        ...
        case 24:
          ...
          _context3.next = 27;
          return checkPhoneExistOrNot(TABLE.CONTACTINQUIRY_TABLE, phone, id);
        case 27:
          phoneExists = _context3.sent;
          if (!phoneExists) {
            _context3.next = 30;
            break;
          }
        ...
        case 30:
          updateQuery = "UPDATE ".concat(TABLE.CONTACTINQUIRY_TABLE, " SET name=?, email = ?, phone = ?, message = ?, updated_at = NOW()");
          queryParams = [name, email, phone, message];
  ...
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
            ...
            var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(deletedId) {
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.next = 2;
                    return pool.query("SELECT * FROM ".concat(TABLE.CONTACTINQUIRY_TABLE, " WHERE status = 1 and id = ?"), [deletedId]);
                  case 2:
                  case "end":
        ...
        case 7:
          query = "UPDATE ".concat(TABLE.CONTACTINQUIRY_TABLE, " SET status = 0, deleted_at = NOW() WHERE id IN (?)");
          _context5.next = 10;
